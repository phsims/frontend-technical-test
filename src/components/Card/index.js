      ...
      {fallbackImage && (
        <div className="card__image-wrapper">
          <picture className="card__image-wrapper__picture">
            {smallImage && <source media="(max-width: 767px)" srcSet={smallImage.url} className="card__picture-source" />}
            {largeImage && <source media="(min-width: 768px)" srcSet={largeImage.url} className="card__picture-source" />}
